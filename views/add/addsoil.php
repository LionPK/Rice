 <?php
    $Soilid = Session::get('Soilid');
?>
 <body>
 <div class="col-lg-6">
                    <div class="card">
                      <div class="card-header"><strong>เพิ่มข้อมูล</strong><small> ดิน</small></div>
                      <div class="card-body card-block">
                        <form action="addsoildata" method="post">
                        <div class="form-group"><label for="ID" class=" form-control-label">รหัส</label>
                          <input type="text" name="ID" id="ID" placeholder="" class="form-control" value="<?php echo $Soilid; ?>" readonly></div> 
