...
?>
 ...
 <div class="col-lg-6">
                    <div class="card">
                      <div class="card-header"><strong>เพิ่มข้อมูล</strong><small> ปุ๋ย</small></div>
                      <div class="card-body card-block">
                        <form action="addfertilizerdata" method="post">
                        <div class="form-group"><label for="ID" class=" form-control-label">รหัส</label>
                          <input type="text" name="ID" id="ID" placeholder="" class="form-control" value="<?php echo $fertilizer; ?>" readonly></div>
