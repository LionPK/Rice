 <?php
    $riceedit = Session::get('riceedit');
?>
 <body>
  <?php  //print_r($riceedit); ?>
 <div class="col-lg-6">
                    <div class="card">
                      <div class="card-header"><strong>แก้ไขข้อมูล</strong><small> พันธุ์ข้าว</small></div>
                      <div class="card-body card-block">
                        <form action="aftereditrice" method="post">
                        <div class="form-group"><label for="ID" class=" form-control-label">รหัส</label>
                          <input type="text" name="ID" id="ID" placeholder="" class="form-control" value="<?php echo $riceedit['id_rice']; ?>" readonly></div>
                           <div class="form-group"><label for="name" class=" form-control-label">ชื่อพันธุ์</label>
                          <input type="text" name="name" id="name" placeholder="" class="form-control" value="<?php echo $riceedit['name_rice']; ?>"></div>
                         <div class="row form-group">
                            <div class="col col-md-3"><label for="select" class=" form-control-label">ประเภท</label></div>
                            <div class="col-12 col-md-9">
                              <select name="select" id="select" class="form-control">
                                <option value="<?php echo $riceedit['type_rice']; ?>"><?php echo $riceedit['type_rice']; ?></option>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><textarea name="textinput" id="textinput" rows="9" placeholder="" class="form-control"><?php echo $riceedit['detail_rice']; ?></textarea><br></div>
                          </div>
                           <center>
